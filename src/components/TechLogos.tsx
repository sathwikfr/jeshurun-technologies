...
export const AwsLogo = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 50 30" className={className || "w-5 h-5"} fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M13.2 12.8c0-.7.4-1.3 1.2-1.6.8-.3 1.8-.4 3-.4 1.3 0 2.3.2 3.1.5v-1.7c0-.7-.2-1.2-.7-1.5-.5-.3-1.2-.4-2.1-.4-1.2 0-2.3.3-3.2 1l-.9-1.5c1.2-.9 2.7-1.3 4.4-1.3 1.7 0 3 .4 3.9 1.1.9.7 1.3 1.8 1.3 3.3v7h-2.5v-1.1c-.9.9-2.1 1.3-3.6 1.3-1.3 0-2.4-.3-3.1-1-.7-.7-1.1-1.5-1.1-2.6zm6.1 1.4c.8 0 1.5-.2 2.1-.7.6-.5.9-1.2.9-2.1v-.8c-.6-.3-1.4-.5-2.3-.5-.8 0-1.4.1-1.8.4-.4.3-.6.7-.6 1.3 0 .5.2.9.5 1.1.4.2 1 .3 1.2.3z" fill="#FF9900" />
    <path d="M25.3 6.6h2.7l1.8 7.3 1.9-7.3h2.5l1.9 7.3 1.8-7.3h2.7l-3.1 11h-2.6l-1.9-7.1-1.9 7.1h-2.6l-3.2-11z" fill="#FF9900" />
    <path d="M42.3 14.5c.7.4 1.6.6 2.6.6.9 0 1.5-.2 1.9-.5.4-.3.6-.7.6-1.2 0-.4-.2-.8-.6-1-.4-.2-1.1-.5-2.2-.8-1.4-.4-2.4-.9-3-1.4-.6-.5-.9-1.3-.9-2.3 0-1.1.5-2 1.4-2.6.9-.6 2.1-.9 3.6-.9 1.4 0 2.7.3 3.7 1l-1 1.6c-.8-.5-1.7-.8-2.7-.8-.8 0-1.4.2-1.8.5-.4.3-.6.7-.6 1.1 0 .4.2.7.5.9.3.2 1 .4 2.1.8 1.5.4 2.5.9 3.1 1.5.6.6.9 1.4.9 2.4 0 1.2-.5 2.1-1.4 2.7-1 .6-2.3.9-3.9.9-1.6 0-3.1-.4-4.3-1.1l1.1-1.7z" fill="#FF9900" />
    <path d="M9.8 23.5c7.3 3.9 16.9 3.9 24.7.1.4-.2.9.1.7.5-1 1.4-8.8 5.4-19 2.2-.4-.1-.8-.5-.4-.8z" fill="#FF9900" />
    <path d="M35.6 22.9c-.4-.4-2.3-.2-3.1 0-.3.1-.3-.2 0-.3 1.5-.8 3.9-.6 4.3-.1.4.4.1 2.8-.7 4.2-.2.3-.4.2-.3-.1.3-.9.3-2.7-.2-3.7z" fill="#FF9900" />
  </svg>
);
