  ...
  return (
    <>
      ...
      <motion.header
        ...
        className={`fixed top-4 md:top-5 left-1/2 z-50 w-[calc(100%-32px)] max-w-[1340px] ${!isVisible ? "pointer-events-none" : ""}`}
      >
        ...
        {/* Right Section: Search Input, Contact Us & Theme Toggle */}
        <div className="flex items-center gap-2 lg:gap-3 shrink-0">
          {/* Search Input (Positioned to the left of Theme Toggle) */}
